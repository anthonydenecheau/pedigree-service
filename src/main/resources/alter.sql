CREATE UNIQUE INDEX ku_pg_data ON pg_data (iddog);
...
--REINDEX TABLE PG_DATA;

CREATE UNIQUE INDEX ku_pg_arbre_genealogie ON pg_arbre_genealogie (id_chien);
...
--REINDEX TABLE PG_ARBRE_GENEALOGIE;